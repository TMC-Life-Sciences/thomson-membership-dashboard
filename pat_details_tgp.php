...
if (isset($_GET['id'])) {
    $pat_idd = $_GET['id'];
    $pat_id = encryptor('decrypt', $pat_idd);

    $sql = "SELECT * FROM pat_tgp WHERE `pat_id` = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $pat_id); // "s" for string
    $stmt->execute();
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Patient's Details <?php echo $pat_id; ?><code style="font-size:inherit;">(<?php echo 'Updated ' . $last_update . ' ' . $user_update; ?>)</code></h4>
                                    <div class="table-responsive pt-3">
                                        <table class="table table-bordered" id="tgpTable">
                                            <thead class="">
                                    ...
                                    <br>
                                    <button type="submit" name="export" class="btn btn-success mr-2" onclick="exportTableToCSVTGP()">Export</button>
